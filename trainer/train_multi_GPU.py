...
import utils.train_eval_utils as teutils
...
def main(args):
    ...
    if args.test_only:
        teutils.evaluate(model, data_loader_test, device=device,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        mean_loss, lr = teutils.train_one_epoch(model, optimizer, data_loader,
        ...
        key_info = teutils.evaluate(model, data_loader_test, device=device,
                                  flip=True, flip_pairs=person_kps_info["flip_pairs"])
